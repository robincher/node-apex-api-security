...
ApiSigningUtil.getBaseString = (authPrefix, signatureMethod, appId, urlPath, httpMethod, formJson, nonce, timestamp) => {
...
ApiSigningUtil.getToken = (realm, authPrefix, httpMethod, urlPath, appId, secret, formJson, passphrase, certFileName, nonce, timestamp) => {
    ...
    var baseString = ApiSigningUtil.getBaseString(apexPrefix, signatureMethod, appId, urlPath, httpMethod, formJson, apexNonce, apexTimestamp);
