 ...
 *
 * @param string urlPath API URL
 * @param string token HTTP Authorization Header content (Signature Token)
 * @param object formData x-url-encode form data fields in JSON object
 * @param string httpMethod HTTP Method
 * @param string port  API URL Port number
 *
 * @returns object API Response
 * @public
 */
ApiSigningUtil.sendRequest = (urlPath, token, formData, httpMethod, port) => {
